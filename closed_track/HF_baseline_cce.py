...
class BERT_multiclass(nn.Module):
    '''
    ...
    def __init__(self, h1_dim=600, h2_dim=20, embedding_size=768):
        ...
        self.layer3 = torch.nn.Linear(h2_dim, 8)
    ...
    def forward(self, input_ids=None, attention_mask=None, labels=None, **kwargs):
        ...
        if labels is not None:
            #loss = corn_loss_with_logits(logits, labels, num_labels=self.num_labels)
...
#         print(logits.shape)
#         loss_fn = nn.CrossEntropyLoss()
#         loss = loss_fn(logits, labels.long())  # Convert one-hot to class index
...
def main():
    ...
    wandb_run_log = wandb.init(
            ...
            config={
                ...
                "architecture": "Baseline with categorial labels (not regression) using Categorical Cross Entropy",
                "part": args.part,
                "epochs": args.epochs,
    ...
    # Suppose you have ctm_file_train, ctm_file_val, actual_score_file_train, etc.
